const String app_name ="Signals from Mars";
String page0(String name) => "On your return trip from studying Saturn\'s rings, you hear a distress signal that seems to be coming from the surface of Mars. It\'s strange because there hasn\'t been a colony there in years. Even stranger, it\'s calling you by name: Help me, %1$name  you re my only hope.";
String page0_choice1 = "Stop and investigate";
String page0_choice2 ="Continue home to Earth";

String page1 = "You deftly land your ship near where the distress signal originated. You didn\'t notice anything strange on your fly-by, but there is a cave in front of you. Behind you is an abandoned rover from the early 21st century.";
String page1_choice1= "Explore the cave";
String page1_choice2 = "Explore the rover";
...
String page2_choice1 = "Head back to Mars to investigate";
String page2_choice2 = "Continue home to Earth";
...
String page5 (String name)=>"After a long walk slightly uphill, you end up at the top of a small crater. You look around, and are overjoyed to see your favorite android, $name. It had been lost on a previous mission to Mars! You take it back to your ship and fly back to Earth.";
...
String play_again_buttontext = "Play Again!";